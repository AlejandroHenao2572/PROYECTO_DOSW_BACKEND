...
public class EstudianteController {
    ...
    public ResponseEntity<?> consultarHorarioPorSemestre(
            @Parameter(
                name = "idEstudiante",
    ...
    public ResponseEntity<?> consultarSemaforoAcademico(
            @Parameter(
                name = "idEstudiante",
                description = "Código único del estudiante",
                required = true,
    ...
    public ResponseEntity<?> consultarSolicitudesPorId(
            @Parameter(
                name = "idEstudiante",
                description = "Código único del estudiante",
                required = true,
    ...
    public ResponseEntity<?> cancelarMateria(
            @Parameter(
                name = "idEstudiante",
                description = "Código único del estudiante",
                required = true,
    ...
    public ResponseEntity<?> consultarSolicitudesPorEstado(
            @Parameter(
                name = "estado",
